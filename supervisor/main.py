...
Examples:
  ...
  python supervisor/main.py --stages epic_strategist feature_decomposer
  ...
  python supervisor/main.py --human-review --save-intermediate
    ...
    parser.add_argument(
        '--stages',
        nargs='+',
        choices=['epic_strategist', 'feature_decomposer', 'developer_agent', 'qa_tester_agent'],
...
def execute_resume_mode(supervisor: WorkflowSupervisor, args, logger):
    ...
    try:
        ...
        if 'epic_strategist' in filename:
            resume_stage = 'feature_decomposer'
        elif 'feature_decomposer' in filename:
            resume_stage = 'developer_agent'
        elif 'developer_agent' in filename:
            resume_stage = 'qa_tester_agent'
        else:
            # If can't determine, ask user
            all_stages = ['epic_strategist', 'feature_decomposer', 'developer_agent', 'qa_tester_agent']
